...
if( (!empty($_POST['action']))||(!empty($_POST['selector'])) )
{
  ...
  { 
   ...
   if(!($link->query(sprintf($add_Stmt,$selector_name,$selector_description,$analysemodule_fk,$analysemodule_cfg_fk)))) 
   {
  ...
  { 
    ...
    if(!($link->query(sprintf($update_Stmt,$selector_name,$selector_description,$analysemodule_fk,$analysemodule_cfg_fk,$pk)))) 
    {
