<?php /* Smarty version 2.6.7, created on 2007-06-15 13:33:40
         compiled from new_teacher.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'new_teacher.tpl', 47, false),array('function', 'html_select_date', 'new_teacher.tpl', 59, false),)), $this); ?>
        ...
        <tr>
          ...
          <td class="table_data">
            <select name="teacher_sex">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['teacher_sex_options'],'selected' => $this->_tpl_vars['teacher_sex_id']), $this);?>
...
" size="30"> </input>
        ...
        <tr>
          ...
          <td class="table_data">  <?php echo smarty_function_html_select_date(array('time' => $this->_tpl_vars['teacher_date_of_birth'],'start_year' => "-100",'end_year' => "+5",'prefix' => 'teacher_birth_','month_empty' => 'Month','day_empty' => 'Day','year_empty' => 'Year'), $this);?>
  </td>
        </tr>
        <tr>
	      ...
	      <td class="table_data">
            <select name="teacher_place_of_birth">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['teacher_place_of_birth_options'],'selected' => $this->_tpl_vars['teacher_place_of_birth_id']), $this);?>
        ...
        <tr>
	      ...
	      <td class="table_data">
            <select name="teacher_nationality">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['teacher_nationality_options'],'selected' => $this->_tpl_vars['teacher_nationality_id']), $this);?>
        ...
        <tr>
	      ...
	      <td class="table_data">
            <select name="teacher_religion">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['teacher_religion_options'],'selected' => $this->_tpl_vars['teacher_religion_id']), $this);?>
        ...
        <tr>
	      ...
	      <td class="table_data">
            <select name="teacher_language">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['teacher_language_options'],'selected' => $this->_tpl_vars['teacher_language_id']), $this);?>
		...
		<tr>
	      ...
	      <td class="table_data">
            <select name="teacher_marital_status">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['teacher_marital_status_options'],'selected' => $this->_tpl_vars['teacher_marital_status_id']), $this);?>
        ...
        <tr>
	      ...
	      <td class="table_data">
            <select name="teacher_children">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['teacher_children_options'],'selected' => $this->_tpl_vars['teacher_children_id']), $this);?>
...
<table>
  <tr>
    ...
    <td class="table_data">  <?php echo smarty_function_html_select_date(array('time' => $this->_tpl_vars['teacher_date_of_employment'],'start_year' => "-100",'end_year' => "+5",'prefix' => 'teacher_employment_','year_empty' => 'Year','month_empty' => 'Month','day_empty' => 'Day'), $this);?>
  </td>
  </tr>
  <tr>
...
" size="30"> </input>
  ...
  <tr>
    <td colspan="2">
      <table>
	    <tr>
          <td colspan="5" align="center" class="table_data_red">One selection</td>
        </tr>
        <tr>
