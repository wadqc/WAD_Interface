...
function print_single_student($class_ref,$department,$class,$school_year,$grade,$school,$pb)
{
require("../globals.php") ;
require_once("./common.php") ;
require_once("./parental_function.php") ;
...
//obtain parental info
$father_ref=$field_student->father_ref;
$mother_ref=$field_student->mother_ref;
$guardian_ref=$field_student->guardian_ref;
...
$picture_src=sprintf("image_resize.php?f_name=$picture_full_path&height=180");
...
$student_table->assign("student_picture",$picture_src);
...
if ($pb==1)
{
  $page_break=sprintf("<div style=\"page-break-after:always\"></div>");
  $student_table->assign("page_break",$page_break);
}
