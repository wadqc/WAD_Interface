<?php /* Smarty version 2.6.7, created on 2010-01-18 02:22:05
         compiled from new_student.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'new_student.tpl', 47, false),array('function', 'html_select_date', 'new_student.tpl', 53, false),)), $this); ?>
...
" size="30"> </input>
        ...
        <tr>
          ...
          <td class="table_data">
            <select name="student_sex">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['student_sex_options'],'selected' => $this->_tpl_vars['student_sex_id']), $this);?>
        ...
        <tr>
          ...
          <td class="table_data">  <?php echo smarty_function_html_select_date(array('time' => $this->_tpl_vars['student_date_of_birth'],'start_year' => "-100",'end_year' => "+5",'reverse_years' => 'true','prefix' => 'student_','month_empty' => 'Month','day_empty' => 'Day','year_empty' => 'Year'), $this);?>
  </td>
        </tr>
        <tr>
	      ...
	      <td class="table_data">
            <select name="student_place_of_birth">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['student_place_of_birth_options'],'selected' => $this->_tpl_vars['student_place_of_birth_id']), $this);?>
        ...
        <tr>
	      ...
	      <td class="table_data">
            <select name="student_nationality">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['student_nationality_options'],'selected' => $this->_tpl_vars['student_nationality_id']), $this);?>
...
" size="30"> </input>
		...
		<tr>
          ...
          <td class="table_data"><?php echo smarty_function_html_select_date(array('time' => $this->_tpl_vars['student_expiration_date'],'start_year' => "-5",'end_year' => "+5",'reverse_years' => 'true','prefix' => 'expiration_id_','month_empty' => 'Month','day_empty' => 'Day','year_empty' => 'Year'), $this);?>
  </td>
        </tr>
        <tr>
	      ...
	      <td class="table_data">
            <select name="student_religion">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['student_religion_options'],'selected' => $this->_tpl_vars['student_religion_id']), $this);?>
        ...
        <tr>
	      ...
	      <td class="table_data">
		    <input   name="student_language" type="text" value="<?php echo $this->_tpl_vars['default_student_language']; ?>
" size="30"> </input>
          </td>
        </tr>
      </table>
...
" size="30"> </input>
        ...
        <tr align="left">
		  <td colspan="2" class="table_data_blue">
		    <table>
              <tr>
			    <td class="table_data_blue">Public transport:</td>
			    <td class="table_data_blue">To school</td>
		        <td class="table_data"> <input type="checkbox" <?php echo $this->_tpl_vars['checked_to_school']; ?>
 name="to_school" value="on"> </td>
                <td class="table_data_blue">From school</td>
		        <td class="table_data"> <input type="checkbox" <?php echo $this->_tpl_vars['checked_from_school']; ?>
 name="from_school" value="on"> </td>
	          </tr>
			</table>
		  </td>
        </tr>
		<tr>
	      ...
	      <td class="table_data">
            <input name="student_free_field1" type="text" value="<?php echo $this->_tpl_vars['default_student_free_field1']; ?>
" size="30"></input>
          </td>
        </tr>
		<tr>
	      ...
	      <td class="table_data">
            <input name="student_free_field2" type="text" value="<?php echo $this->_tpl_vars['default_student_free_field2']; ?>
" size="30"></input>
          </td>
        </tr>
      </table>
        ...
        <tr>
          ...
          <td class="table_data">
            <select name="registration_comes_from">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['registration_comes_from_options'],'selected' => $this->_tpl_vars['registration_comes_from_id']), $this);?>
    ...
    <tr>
      <td>
        <table>
		  ...
		  <tr>
            <td class="table_data">  <?php echo smarty_function_html_select_date(array('time' => $this->_tpl_vars['registration_school_in'],'start_year' => "-100",'end_year' => "+5",'reverse_years' => 'true','prefix' => 'school_in_','month_empty' => 'Month','day_empty' => 'Day','year_empty' => 'Year'), $this);?>
  </td>
          </tr>
		  <tr>
		  ...
		  <tr>
		    <td class="table_data">  <?php echo smarty_function_html_select_date(array('time' => $this->_tpl_vars['registration_school_out'],'start_year' => "-100",'end_year' => "+5",'reverse_years' => 'true','prefix' => 'school_out_','month_empty' => 'Month','day_empty' => 'Day','year_empty' => 'Year'), $this);?>
  </td>
		  </tr>
        </table>
      </td>
      <td>
        <table>
		  ...
		  <tr>
            <td class="table_data">  <?php echo smarty_function_html_select_date(array('time' => $this->_tpl_vars['registration_department_in'],'start_year' => "-100",'end_year' => "+5",'reverse_years' => 'true','prefix' => 'department_in_','month_empty' => 'Month','day_empty' => 'Day','year_empty' => 'Year'), $this);?>
  </td>
		  </tr>
		  <tr>
		    <td class="table_data_blue"> Written out date </td>
		  ...
		  <tr>
		    <td class="table_data">  <?php echo smarty_function_html_select_date(array('time' => $this->_tpl_vars['registration_department_out'],'start_year' => "-100",'end_year' => "+5",'reverse_years' => 'true','prefix' => 'department_out_','month_empty' => 'Month','day_empty' => 'Day','year_empty' => 'Year'), $this);?>
  </td>
          </tr>
        </table>
      </td>
      <td>
        <table>
          <tr>
            ...
            <td class="table_data_blue"> <select name="registration_profile"><?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['registration_profile_options'],'selected' => $this->_tpl_vars['registration_profile_id']), $this);?>
 </select></td>
          </tr>
		</table>
	  </td>
...
" size="30"> </input>
          ...
          <td class="table_data">
            <select name="registration_reason_out">
              <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['registration_reason_out_options'],'selected' => $this->_tpl_vars['registration_reason_out_id']), $this);?>
  ...
  <tr>
    ...
    <td class="table_data">
         <select name="medical_doctor_ref">
           <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['medical_doctor_options'],'selected' => $this->_tpl_vars['medical_doctor_id']), $this);?>
  ...
  <tr>
    ...
    <td class="table_data">
         <select name="medical_vaccination_card">
           <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['medical_vaccination_card_options'],'selected' => $this->_tpl_vars['medical_vaccination_card_id']), $this);?>
  ...
  <tr>
    ...
    <td class="table_data">
      <select name="student_lives_with">
        <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['student_lives_with_options'],'selected' => $this->_tpl_vars['student_lives_with_id']), $this);?>
